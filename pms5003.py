...
# FROM: GitHub
# AUTHOR: Jesse Spielman (https://github.com/heavyimage)
# URL: https://github.com/pimoroni/pms5003-micropython
# LICENSE: The following code is used under the MIT License.
# FULL LICENSE TEXT: https://github.com/pimoroni/pms5003-micropython/blob/main/LICENSE.txt
